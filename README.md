...
| 专业班级 | 计算机科学与技术 222 班 |
| 完成时间 | 2026 年 5 月 |
| 项目地址 | https://github.com/lksama316/wechat-book-shop |

### 致谢

本课题从选题、需求分析、系统设计到编码实现与论文撰写，得到了指导教师的悉心指导，在此谨向指导教师致以诚挚的谢意。同时感谢学院各位老师在大学期间的培养，感谢同学们在系统测试与使用反馈中提供的帮助。

系统在开发过程中参考了 Spring Boot、MyBatis、Vue、uni-app 与 uView UI 等开源项目的官方文档及社区资料，在此向上述开源项目及其贡献者表示感谢。

---

> 本项目为本科毕业设计作品，主要用于学习与技术实践，支付环节为模拟实现，未接入真实支付渠道。
