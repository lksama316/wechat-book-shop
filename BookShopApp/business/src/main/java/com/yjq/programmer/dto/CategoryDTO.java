...
public class CategoryDTO {
    ...
    @ValidateEntity(required=true,requiredMaxLength=true,requiredMinLength=true,maxLength=8,minLength=1,errorRequiredMsg="商品分类名称不能为空！",errorMaxLengthMsg="商品分类名称长度不能大于8！",errorMinLengthMsg="商品分类名称不能为空！")
    private String name;
